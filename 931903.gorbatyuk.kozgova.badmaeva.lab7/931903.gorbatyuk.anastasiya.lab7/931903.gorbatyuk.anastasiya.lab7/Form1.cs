...
namespace _931903.gorbatyuk.anastasiya.lab7
{
    public partial class Form1 : Form
    {
        ...
        double TicketPriceMin = 1 ; //минимальная цена билета
        ...
        int NumberAvia=5; // число авиакомпаний
        ...
        private void btStart_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Budget = (double)edBudget.Value; // бюджет аэропорта
                TicketPrice = (double)edTiсketPrice.Value; // цена билета
                MaxBudget = Budget;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                ostN = ost;
                EvolutionCoef = rnd.NextDouble(); //коэфициент расширения 
                EvolutionCoefSum += EvolutionCoef; //накапливаем коэфициент развития

                OutlayStaff += (EvolutionCoefSum * OutlayStaff); // обновление количества персонала
                Infrastructure += (EvolutionCoefSum * Infrastructure); //обновление инфраструктуры
                AvailableDestinations += (int)(EvolutionCoefSum * AvailableDestinations); //обновление доступных направлений
